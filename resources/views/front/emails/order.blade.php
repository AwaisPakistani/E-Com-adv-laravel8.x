...
<tr><td>&nbsp;</td></tr>
<tr><td>Thank you for Shopping.@if(!empty($courier_name)) Your courier name is {{$courier_name}} @endif @if(!empty($tracking_nmuber)) and tracking number is {{$tracking_number}}@endif.</td></tr>
<tr><td>&nbsp;</td></tr>
