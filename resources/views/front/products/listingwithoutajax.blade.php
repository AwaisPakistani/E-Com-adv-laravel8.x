	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				...
				<!-- /ASIDE -->
                <div>
                	<h2>{{$categoryDetails['catDetails']['category_name']}}</h2><hr>
						...
						<div class="pull-left">
							...
							<div class="sort-filter">
								...
								<select class="input" name="sort" id="sort">
									    ...
									    <option value="latest_products">Latest</option>
										<option value="product_name_a_z">Name A-Z</option>
										<option value="product_name_z_a">Name Z-A</option>
										<option value="lowest_price">Low Price 1st</option>
										<option value="highest_price">High Price 1st</option>
								</select>
								...
								<div class="product product-single">
								  ...
								  @endif
									...
									<div class="product-body">
										...
										<h2 class="product-name"><a href="#">{{ $product['product_name']}}-{{$product['id']}}</a></h2>
