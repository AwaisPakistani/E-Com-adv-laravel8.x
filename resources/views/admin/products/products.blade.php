            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td> <a title="Delete Product" href="{{url('admin/delete-product/'.$pro->id)}}" onclick="return confirm('Are you sure you want to delete this Product?')" class="btn btn-danger" btn-sm><i class="fas fa-trash"></i></a>
