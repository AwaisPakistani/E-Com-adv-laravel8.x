        ...
        <div class="row">
          <div class="col-md-6">
             <div class="card card-primary">
              ...
              <form role="form" action="{{url('admin/update-admin-details')}}" method="post" enctype="multipart/form-data" id="updateDetailForm" name="updateDetailForm">@csrf
                <div class="card-body">
                   
                  <div class="form-group">
                    <label for="exampleInputEmail1">Email address</label>
                    <input type="email" name="email" class="form-control" id="email" readonly="" value="{{ Auth::guard('admin')->user()->email }}">
                  </div>
                   <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="mobile" class="form-control" placeholder="Enter Mobile number here" id="mobile" value="{{ Auth::guard('admin')->user()->mobile }}">
